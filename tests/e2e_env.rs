...
"#, TEST_GROUP));
    ...
    assert!(result.stdout.contains("MY_VAR=from_env_file"), "stdout: {}", result.stdout);
}
...
"#, TEST_GROUP));
    ...
    assert!(result.stdout.contains("Started optional-env"), "stdout: {}", result.stdout);
}
...
"#, TEST_GROUP));
    ...
    assert!(result.stdout.contains("MY_VAR=from_inline"), "stdout: {}", result.stdout);
}
...
"#, TEST_GROUP));
    ...
    assert!(result.stderr.contains("Failed to load env file"), "stderr: {}", result.stderr);
}
